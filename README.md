...
On Spartan and Raijin, instead of feeding the truth VCF directly, one can use presets (see https://github.com/umccr/hpc_utils/#hpc-paths). Same applies to the reference fasta - one can provide the genome build name instead of the full path to .fa file.
